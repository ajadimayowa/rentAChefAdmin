...
const NewChefModal: React.FC<IAuthModal> = ({ on, off, onLogin }) => {
    ...
    return (
        <Modal size="lg" show={on} onHide={() => window.location.reload()} centered>
            <Modal.Header closeButton>
                <Modal.Title className="d-flex gap-3">{step > 1 && <i onClick={() => setStep(step - 1)} className="bi bi-arrow-left" role="button"></i>} Create New Chef</Modal.Title>
            </Modal.Header>
