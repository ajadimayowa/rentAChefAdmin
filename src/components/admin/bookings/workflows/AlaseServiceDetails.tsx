...
export function AlaseServiceDetails({ booking }: {booking: BookingDetail;}) {
  const d = booking.bookingData || {};
  const theme = WORKFLOW_THEME.ALASE_SERVICE;
  ...
  return (
    <>
      <WorkflowFieldsCard
        ...
        description="Dates and arrival window for the Alase service"
