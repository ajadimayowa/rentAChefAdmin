...
export function EventCateringDetails({ booking }: {booking: BookingDetail;}) {
  const d = booking.bookingData || {};
  const theme = WORKFLOW_THEME.EVENT_CATERING;
  ...
  return (
    <>
      <WorkflowFieldsCard
        ...
        description="Dates and arrival window for the event"
      ...
      <WorkflowFieldsCard title="Event location & instructions">
